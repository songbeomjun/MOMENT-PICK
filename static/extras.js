...
function createBGM() {
  ...
  master.gain.setValueAtTime(0.3, bgmCtx.currentTime);
  ...
  freqs.forEach(function(freq, i) {
    ...
    gain.gain.setValueAtTime(0.5 / (i + 1), bgmCtx.currentTime);
    osc.connect(gain);
    gain.connect(master);
    osc.start();
    setInterval(function() {
      ...
      gain.gain.setTargetAtTime(0.5 / (i + 1) * (0.6 + Math.random() * 0.4), t, 2 + i);
    }, 3000 + i * 1000);
  });
}
